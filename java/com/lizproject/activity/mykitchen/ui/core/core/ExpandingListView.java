...
public class ExpandingListView extends ListView
{
     ...
     */
    private int[] getTopAndBottomTranslations(int top, int bottom, int yDelta,   boolean isExpanding,int count)
    {
        int yTranslateTop = 0;
        ...
        observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
        {
            ...
            public boolean onPreDraw()
            {
                ...
                if (!mShouldRemoveObserver)
                {
                    ...
                    mTranslate = getTopAndBottomTranslations(oldTop, oldBottom,  delta, true, childCount);
